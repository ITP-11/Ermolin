...
WScript.StdOut.WriteLine "2. Pereimenovanie zadannoi papki"
...
if (s="1") Then
WScript.StdOut.WriteLine "Ermolin Daniil Kostantinovich, ITP - 11"
elseif (s="2") Then
    WScript.StdOut.WriteLine "Vvedite put k failu"
    s = WScript.StdIn.ReadLine
    WScript.StdOut.WriteLine "Vvedite novoe nazvanie papki"
